...
public class AutoStraightLeft extends CommandBase {
  ...
  public AutoStraightLeft(DriveSubsystem driveSubsystem) 
  {
    // Use addRequirements() here to declare subsystem dependencies.
    m_driveSubsystem = driveSubsystem;

    this.path = SwervePath.fromCSV("Straight Left Position");  
